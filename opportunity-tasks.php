...
</style></head><body><main class="page"><div class="top"><div><h1>Opportunity Task Center</h1><div>Follow-ups, deadlines and sales actions.</div></div><div class="links"><a class="btn white" href="salesworkflow.php">← Sales Workflow</a> <a class="btn white" href="opportunities.php">Pipeline</a> <a class="btn white" href="opportunity-report.php">Reports</a></div></div>
